...
Djks::Djks(void)
{
    ...
    int filled[num][num] = {0};       //whether cell is colored
    int grid[num][num] = {0};       //map with obstacle
    pair<int,int> previous[num][num] = {make_pair(0,0)};
    float dist[num][num] = {0.0};
